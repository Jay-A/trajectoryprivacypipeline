...
This project uses the Simulation of Urban MObility (SUMO) traffic simulator for microscopic mobility simulation and trajectory generation as a submodule.
